...
module.exports = {
    get: function(content, options) {
        switch(content) {
            ...
            case "farmEmbedDescription": return `Para comprar qualquer item relacionado a fazenda, ou até mesmo a fazenda, use \`${options.usage}\`.\n**Fazenda:** ${emojis["asura"]} 400.000 \`(libera o emprego de fazendeiro)\`\n**Galinha:** ${emojis["asura"]} 100 \`(aumenta o lucro da fazenda em 5%)\`\n**Vaca:** ${emojis["asura"]} 550 \`(aumenta o lucro da fazenda em 15%)\``
