...
module.exports = {
    get: function(content, options = {}) {
        switch(content) {
            ...
            case 'oddEvenLoser': return `Parabéns, você perdeu! Você escolheu \`${options.chosen}\` (${options.chosen === 'odd' ? 'ímpar' : 'par'}), e ${options.number} é ${options.chosen !== 'odd' ? 'ímpar' : 'par'}! ${options.user} ganhou ${options.granex} granex.`
            ...
            case 'noGranex': return `São necessárias 5,000 granex de cada para que se casem.`
            ...
            case 'bankNoGranex': return `Parece que o banco ficou sem dinheiro... aguarde até o banco seja reabastecido e tente novamente.`
            ...
            case 'youWorked': return `Você trabalhou duro como \`${options.job}\` e recebeu ${options.granexGain} granex e ${options.xpGain} xp.`
            ...
            case 'payConfirm': return `Você está prestes a transferir ${options.granex} granex para ${options.user}. Tem certeza disso?`
            ...
            case 'successfulRobbery': return `Roubo efetuado com sucesso! Você conseguiu roubar ${options.value} granex deste usuário.`
            case 'unsuccessfulRobbery': return `Ih, rapaz! Parece que a polícia te pegou bem no ato. Você pagou uma multa de ${options.value} granex.`
            ...
            case 'userFined': return `Usuário multado com sucesso!\nA multa é de 35.000 granex e, após pagar a multa, o usuário tem sua arma confiscada.`
